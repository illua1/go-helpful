...
/*
  Invert Rotate matrix (Auler) (X Y Z)
*/

func InvertRotate3x3_XYZ[Value value.Values, Angle value.Values](angle [3]Angle) Matrix[Value, [3]Value, [3][3]Value] {
	return Matrix3x3[Value]().Mull(
		InvertRotate3x3_x[Value](angle[0]),
	).Mull(
		InvertRotate3x3_y[Value](angle[1]),
	).Mull(
		InvertRotate3x3_z[Value](angle[2]),
	)
}

func InvertRotate3x3_XZY[Value value.Values, Angle value.Values](angle [3]Angle) Matrix[Value, [3]Value, [3][3]Value] {
	return Matrix3x3[Value]().Mull(
		InvertRotate3x3_x[Value](angle[0]),
	).Mull(
		InvertRotate3x3_z[Value](angle[2]),
...
func InvertRotate3x3_YZX[Value value.Values, Angle value.Values](angle [3]Angle) Matrix[Value, [3]Value, [3][3]Value] {
	return Matrix3x3[Value]().Mull(
		InvertRotate3x3_y[Value](angle[1]),
	).Mull(
		InvertRotate3x3_z[Value](angle[2]),
...
func InvertRotate3x3_YXZ[Value value.Values, Angle value.Values](angle [3]Angle) Matrix[Value, [3]Value, [3][3]Value] {
	return Matrix3x3[Value]().Mull(
		InvertRotate3x3_y[Value](angle[1]),
	).Mull(
		InvertRotate3x3_x[Value](angle[0]),
...
func InvertRotate3x3_ZYX[Value value.Values, Angle value.Values](angle [3]Angle) Matrix[Value, [3]Value, [3][3]Value] {
	return Matrix3x3[Value]().Mull(
		InvertRotate3x3_z[Value](angle[2]),
	).Mull(
		InvertRotate3x3_y[Value](angle[1]),
...
func InvertRotate3x3_ZXY[Value value.Values, Angle value.Values](angle [3]Angle) Matrix[Value, [3]Value, [3][3]Value] {
	return Matrix3x3[Value]().Mull(
		InvertRotate3x3_z[Value](angle[2]),
	).Mull(
		InvertRotate3x3_x[Value](angle[0]),
...
/*
  ...
  Matrix3x3 Invert Rotate : X [Y and Z] {
    X :  1    0    0
    Y :  0   cos  sin
    Z :  0  -sin  cos
  }
...
func InvertRotate3x3_x[Value value.Values, Angle value.Values](angle Angle) Matrix[Value, [3]Value, [3][3]Value] {
	var m Matrix[Value, [3]Value, [3][3]Value]
	m.A[0][0] = 1
	m.A[1][1] = Value(math.Cos(float64(angle)))
	m.A[1][2] = Value(math.Sin(float64(angle)))
...
/*
  ...
  Matrix3x3 Invert Rotate : Y [X and Z] {
    X : cos   0   sin
    Y :  0    1    0
    Z : sin   0   cos
  }
...
func InvertRotate3x3_y[Value value.Values, Angle value.Values](angle Angle) Matrix[Value, [3]Value, [3][3]Value] {
	var m Matrix[Value, [3]Value, [3][3]Value]
	m.A[0][0] = Value(math.Cos(float64(angle)))
	m.A[0][2] = Value(math.Sin(float64(angle)))
	m.A[1][1] = 1
...
/*
  ...
  Matrix3x3 Invert Rotate : Z [X and Y] {
    X : cos  sin   0
    Y :-sin  cos   0
    Z :  0    0    1
  }
...
func InvertRotate3x3_z[Value value.Values, Angle value.Values](angle Angle) Matrix[Value, [3]Value, [3][3]Value] {
	var m Matrix[Value, [3]Value, [3][3]Value]
	m.A[0][0] = Value(math.Cos(float64(angle)))
	m.A[0][1] = Value(-math.Sin(float64(angle)))
	m.A[1][0] = Value(math.Sin(float64(angle)))
